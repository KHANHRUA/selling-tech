        ...
        <div id="breadcrumb">
          <ol class="breadcrumb">
            <li><router-link to="/">Trang chủ</router-link></li>
              <li class="pad">/</li>
              <li class="color"><router-link to="/domesticnews">Tài khoản ngân hàng</router-link></li>
          </ol>
        </div>
        <div class="flex">
          ...
          <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div id="content" class="content-blog">
              <h1 class="namePage">Tài Khoản ngân hàng</h1>
              <ul class="new_info">
                <li class="created">
                  <span class="fa-regular fa-clock">Cập nhập:</span> 24-10-2015 13:42:49
                </li>
                <li class="hits"><span class="fa fa-eye"> Đã xem: </span>255</li>
              </ul>
              <div class="pav-blog">
                <div class="description clearfix" id="ct-news">
                  <p>Ngân hàng TechcomBankTạ duy Thái</p>
                  <p>Số TK: <span class="red">19025471429991</span></p>
                  <p>
                    Chi nhánh: Techcombank chi nhánh Hoàng Mai - Hà NộiNgân hàng
                    <strong>VietinBankTạ duy Thái</strong>Số TK: <span class="red">108005480800</span>Chi nhánh:
                    Vietinbank chi nhánh Hai Bà Trưng - Hà Nội
                  </p>
                  <p>
                    Ngân hàng<strong>AgribankTạ Duy Thái</strong>Số TK:
                    <span class="red">1440205508639</span>Chi nhánh:Agirbank chi nhánh Bắc Hà Nội
                  </p>
                  <p>
                    Ngân hàng <strong>VPBankTạ Duy Thái</strong>Số TK: <span class="red">91114003</span>Chi
                    nhánh: VPBank Thăng Long - Hà Nội
                  </p>
                  <div
