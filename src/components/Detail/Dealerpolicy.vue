        ...
        <div class="CoreIndex">
          <div id="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="pad">/</li>
              <li class="color"><router-link to="/domesticnews">Chính sách dành cho đại lý</router-link></li>
            </ol>
          </div>
          <div class="flex">
                    ...
                    <div class="pavblog-comments clearfix">
                      <div class="item-news clearfix">
                        ...
                        <span class="news-more">
                          <router-link to="/dealerpolicy"> Xem chi tiết </router-link>
                        </span>
                      </div>
                      <div class="item-news clearfix">
                        <a
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              <div id="content" class="content-blog">
                <h1 class="namePage">Chính sách dành cho đại lý</h1>
                <ul class="new_info">
                  <li class="created">
                ...
                <div class="pav-blog">
                  <div class="description clearfix" id="ct-news">
                    <p style="line-height: 20.8px">
                      <span class="mt-2"><strong>Đang cập nhập</strong></span>
                    </p>
                    <div
