<template>
  <div class="Container">
    <div v-if="object" class="Data">
      <div></div>
    </div>
    <div v-else class="noneData">
      <h1 class="title">Đơn hàng " {{ Code }} " không được tìm thấy</h1>
      <h2>Đề xuất</h2>
      <ul>
      ...
      <h1 class="Text">Theo dõi đơn hàng của bạn</h1>
      <div class="follow">
        <div class="input">
          Mã đơn hàng
        ...
        <div class="buttonAlign">
          <button class="button" @click="send()">Theo dõi</button>
        </div>
      </div>
      <h3>
